...
public class WireInsulationRepair3_1_4_4thPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wire_insulation_repair_3_1_4_4th_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 1) {
                    Intent previousIntent = new Intent(WireInsulationRepair3_1_4_4thPage.this, WireInsulationRepair3_1_4_1stPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 2) {
                    Intent previousIntent = new Intent(WireInsulationRepair3_1_4_4thPage.this, WireInsulationRepair3_1_4_2ndPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 3) {
                    Intent previousIntent = new Intent(WireInsulationRepair3_1_4_4thPage.this, WireInsulationRepair3_1_4_3rdPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 5) {
                    Intent nextIntent = new Intent(WireInsulationRepair3_1_4_4thPage.this, WireInsulationRepair3_1_4_5thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
            }
        });
        txtHeading.setText(Html.fromHtml("<p><u>Wire Insulation Repair (Part 4)</u></p>"));
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(WireInsulationRepair3_1_4_4thPage.this, MainPage.class);
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(WireInsulationRepair3_1_4_4thPage.this, ContentsPage.class);
