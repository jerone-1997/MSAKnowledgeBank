...
public class GeneralSoldering3_1_5_3rdPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.general_soldering_3_1_5_3rd_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 1) {
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_3rdPage.this, GeneralSoldering3_1_5_1stPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 2) {
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_3rdPage.this, GeneralSoldering3_1_5_2ndPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 4) {
                    Intent nextIntent = new Intent(GeneralSoldering3_1_5_3rdPage.this, GeneralSoldering3_1_5_4thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 5) {
                    Intent nextIntent = new Intent(GeneralSoldering3_1_5_3rdPage.this, GeneralSoldering3_1_5_5thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 6) {
                    Intent nextIntent = new Intent(GeneralSoldering3_1_5_3rdPage.this, GeneralSoldering3_1_5_6thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 7) {
                    Intent nextIntent = new Intent(GeneralSoldering3_1_5_3rdPage.this, GeneralSoldering3_1_5_7thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 8) {
                    Intent nextIntent = new Intent(GeneralSoldering3_1_5_3rdPage.this, GeneralSoldering3_1_5_8thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 9) {
                    Intent nextIntent = new Intent(GeneralSoldering3_1_5_3rdPage.this, GeneralSoldering3_1_5_9thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 10) {
                    Intent nextIntent = new Intent(GeneralSoldering3_1_5_3rdPage.this, GeneralSoldering3_1_5_10thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 11) {
                    Intent nextIntent = new Intent(GeneralSoldering3_1_5_3rdPage.this, GeneralSoldering3_1_5_11thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
            }
        });
        txtHeading.setText(Html.fromHtml("<p><u>Flux (Part 2)</u></p>"));
        ...
        SpannableString ss2 = new SpannableString("General Soldering T.O. TO 1-1A-14 WP 16 00");
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(GeneralSoldering3_1_5_3rdPage.this, MainPage.class);
    ...
    public void displaySolderingPopup() {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                txtTitle.setText("WARNING");
                if (position == 1) {
                    txtTitle.setText("Different types of Flux");
                }
                else if (position == 2) {
                    txtTitle.setText("Example of J-STD-004 ROL0 Flux");
                }
                else if (position == 3) {
                    txtTitle.setText("Different types of soldering iron");
                }
                else if (position == 4) {
                    txtTitle.setText("Different types of soldering iron tips");
                }
            }
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(GeneralSoldering3_1_5_3rdPage.this, ContentsPage.class);
    ...
    private class ImagePagerAdapter extends PagerAdapter { //swipe image
        private int[] mImages = new int[] {
                ...
                R.drawable.flux_classification,
                R.drawable.rol0,
        };
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Context context = GeneralSoldering3_1_5_3rdPage.this;
