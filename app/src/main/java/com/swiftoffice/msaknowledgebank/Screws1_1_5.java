...
public class Screws1_1_5 extends AppCompatActivity {
    private FloatingActionButton btnBack;
    private ImageView imgScrews;
    private TextView txtHeading, txtImageIndex, txtHyperLink1, txtHyperLink2;
    private ViewPager viewPager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.screws_1_1_5);
        ...
        SpannableString ss1 = new SpannableString("Types of commonly used Screws");
        ss1.setSpan(new UnderlineSpan(), 0, ss1.length(), 0);
        SpannableString ss2 = new SpannableString("Screws T.O.");
        ...
        txtHeading.setText(Html.fromHtml("<p><u>Screws</u></p>"));
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(Screws1_1_5.this, MainPage.class);
        startActivity(MainIntent);
        finish();
    }
    public void displayScrewsImagePopup() {
        ...
        imageDialog.setTitle("Types of commonly used Screws in aircraft");
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(Screws1_1_5.this, ContentsPage.class);
    ...
    private class ImagePagerAdapter extends PagerAdapter { //swipe image
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Context context = Screws1_1_5.this;
            imgScrews = new ImageView(context);
            imgScrews.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
            imgScrews.setImageResource(mImages[position]);
            PhotoViewAttacher zoomImage = new PhotoViewAttacher(imgScrews);
            zoomImage.update();
            ((ViewPager) container).addView(imgScrews, 0);
            return imgScrews;
        }
