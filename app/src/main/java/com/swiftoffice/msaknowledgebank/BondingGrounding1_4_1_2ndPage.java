...
public class BondingGrounding1_4_1_2ndPage extends AppCompatActivity {
    private FloatingActionButton btnBack;
    private ImageView imgBonding;
    private int page;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bonding_grounding_1_4_1_2nd_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 1) {
                    Intent previousIntent = new Intent(BondingGrounding1_4_1_2ndPage.this, BondingGrounding1_4_1_1stPage.class);
                    startActivity(previousIntent);
                    finish();
                }
            }
        });
        txtHeading.setText(Html.fromHtml("<p><u>Bonding Jumper Installation & Connections</u></p>"));
        SpannableString ss1 = new SpannableString("Grounding & Bonding Examples on aircraft");
        ss1.setSpan(new UnderlineSpan(), 0, ss1.length(), 0);
        SpannableString ss2 = new SpannableString("Grounding & Bonding on aircraft T.O. 1-1A-14 WP 017 00");
        ...
        txtHyperLink2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.setData(Uri.parse("https://drive.google.com/file/d/1vIAwwswsYmJa-Czr9vZThBwUCIvd0Jhj/view?usp=sharing"));
                startActivity(i);
            }
        });
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(BondingGrounding1_4_1_2ndPage.this, MainPage.class);
        startActivity(MainIntent);
        finish();
    }

    public void displayBondingImagePopup() {
        ...
        txtTitle.setText("Example of grounding assembly (clamp + plug) used in aircraft");
        txtImageIndex.setText("Current Image: 1/3");
        BondingGrounding1_4_1_2ndPage.ImagePagerAdapter adapter = new BondingGrounding1_4_1_2ndPage.ImagePagerAdapter();
        viewPager.setAdapter(adapter);
        imageDialog.setTitle("Grounding & Bonding Examples on aircraft");
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position == 0) {
                    ...
                    txtTitle.setText("Example of static grounding point to ground the aircraft");
                }
                else if (position == 2) {
                    txtTitle.setText("Example of bonding and grounding cable locations in aircraft");
                }
            }
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(BondingGrounding1_4_1_2ndPage.this, ContentsPage.class);
    ...
    private class ImagePagerAdapter extends PagerAdapter { //swipe image
        private int[] mImages = new int[]{
                R.drawable.grounding_cable,
                R.drawable.static_grounding_point,
                R.drawable.aircraft_grounding_point,
        };
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Context context = BondingGrounding1_4_1_2ndPage.this;
            imgBonding = new ImageView(context);
            imgBonding.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
            imgBonding.setImageResource(mImages[position]);
            PhotoViewAttacher zoomImage = new PhotoViewAttacher(imgBonding);
            zoomImage.update();
            ((ViewPager) container).addView(imgBonding, 0);
            return imgBonding;
        }
