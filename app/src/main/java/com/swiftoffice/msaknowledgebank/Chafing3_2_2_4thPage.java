...
public class Chafing3_2_2_4thPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chafing_3_2_2_4th_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 1) {
                    Intent previousIntent = new Intent(Chafing3_2_2_4thPage.this, Chafing3_2_2_1stPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 2) {
                    Intent previousIntent = new Intent(Chafing3_2_2_4thPage.this, Chafing3_2_2_2ndPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 3) {
                    Intent previousIntent = new Intent(Chafing3_2_2_4thPage.this, Chafing3_2_2_3rdPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 5) {
                    Intent nextIntent = new Intent(Chafing3_2_2_4thPage.this, Chafing3_2_2_5thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 6) {
                    Intent nextIntent = new Intent(Chafing3_2_2_4thPage.this, Chafing3_2_2_6thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
        ...
        txtHeading.setText(Html.fromHtml("<p><u>Wiring Clearances</u></p>"));
        SpannableString ss1 = new SpannableString("Wiring Clearances Examples");
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(Chafing3_2_2_4thPage.this, MainPage.class);
    ...
    public void displayClampingImagePopup() {
        ...
        txtTitle.setText("Minimum 3/8 inch clearance is acceptable onm anti-chafing material");
        txtImageIndex.setText("Current Image: 1/3");
        Chafing3_2_2_4thPage.ImagePagerAdapter adapter = new Chafing3_2_2_4thPage.ImagePagerAdapter();
        viewPager.setAdapter(adapter);
        imageDialog.setTitle("Wiring Clearances Examples");
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position == 0) {
                    ...
                    txtTitle.setText("Minimum 2 inch clearance between fluid carrying lines");
                }
                else if (position == 2) {
                    txtTitle.setText("Separation of wiring from fluid carrying lines using clamps");
                }
            }
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(Chafing3_2_2_4thPage.this, ContentsPage.class);
    ...
    private class ImagePagerAdapter extends PagerAdapter { //swipe image
        private int[] mImages = new int[]{
                ...
                R.drawable.clearances_fluid_lines,
                R.drawable.wire_separation,
        };
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Context context = Chafing3_2_2_4thPage.this;
