...
public class BondingGrounding1_4_1_1stPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bonding_grounding_1_4_1_1st_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 2) {
                    Intent nextIntent = new Intent(BondingGrounding1_4_1_1stPage.this, BondingGrounding1_4_1_2ndPage.class);
                    startActivity(nextIntent);
                    finish();
                }
            }
        });
        txtHeading.setText(Html.fromHtml("<p><u>Grounding & Bonding Definitions</u></p>"));
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(BondingGrounding1_4_1_1stPage.this, MainPage.class);
    ...
    public void displayBondingImagePopup() {
        ...
        BondingGrounding1_4_1_1stPage.ImagePagerAdapter adapter = new BondingGrounding1_4_1_1stPage.ImagePagerAdapter();
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(BondingGrounding1_4_1_1stPage.this, ContentsPage.class);
    ...
    private class ImagePagerAdapter extends PagerAdapter { //swipe image
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Context context = BondingGrounding1_4_1_1stPage.this;
