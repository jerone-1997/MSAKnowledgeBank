...
public class Sealant1_2_3_5thPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sealant_1_2_3_5th_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 1) {
                    Intent nextIntent = new Intent(Sealant1_2_3_5thPage.this, Sealant1_2_3_1stPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 2) {
                    Intent nextIntent = new Intent(Sealant1_2_3_5thPage.this, Sealant1_2_3_2ndPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 3) {
                    Intent nextIntent = new Intent(Sealant1_2_3_5thPage.this, Sealant1_2_3_3rdPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 4) {
                    Intent nextIntent = new Intent(Sealant1_2_3_5thPage.this, Sealant1_2_3_4thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
            }
        });
        txtHeading.setText(Html.fromHtml("<p><u>(3) Sealant Compounds (Part 3)</u></p>"));
        SpannableString ss1 = new SpannableString("Procedures on how to Mix Sealant Compounds");
        ss1.setSpan(new UnderlineSpan(), 0, ss1.length(), 0);
        SpannableString ss2 = new SpannableString("Sealant Mixing T.O.");
        ...
        txtHyperLink2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.setData(Uri.parse("https://drive.google.com/file/d/1Sc9BipPLGwDxIYJCM_jsNnzEwR48-5Dg/view?usp=sharing"));
                startActivity(i);
            }
        });
        txtPrevious.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent previousIntent = new Intent(Sealant1_2_3_5thPage.this, Sealant1_2_3_4thPage.class);
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(Sealant1_2_3_5thPage.this, MainPage.class);
    ...
    public void displaySealantImagePopup() {
        ...
        txtTitle.setText("Determine amount of base compound being used");
        txtImageIndex.setText("Current Image: 1/6");
        Sealant1_2_3_5thPage.ImagePagerAdapter adapter = new Sealant1_2_3_5thPage.ImagePagerAdapter();
        viewPager.setAdapter(adapter);
        imageDialog.setTitle("Procedures on how to Mix Sealant Compounds");
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                txtImageIndex.setText("Current Image: " + String.valueOf(position + 1) + "/" + "6");
                if (position == 0) {
                    txtTitle.setText("Determine amount of base compound being used");
                }
                else if (position == 1) {
                    txtTitle.setText("Determine amount of accelerator being used");
                }
                else if (position == 2) {
                    txtTitle.setText("Weighing the amount of base compound using balance scale");
                }
                else if (position == 3) {
                    txtTitle.setText("Weighing the amount of accelerator together with base compound using balance scale");
                }
                else if (position == 4) {
                    txtTitle.setText("Thoroughly mixing the base compound and accelerator using spatula until the colour is uniform");
                }
                else if (position == 5) {
                    txtTitle.setText("A well mixed compound is formed in uniform colour after mixing");
                }
            }
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(Sealant1_2_3_5thPage.this, ContentsPage.class);
    ...
    private class ImagePagerAdapter extends PagerAdapter { //swipe image
        private int[] mImages = new int[]{
                R.drawable.sealant_base_compound,
                R.drawable.sealant_accelerator,
                R.drawable.sealant_weigh_base_compound,
                R.drawable.sealant_weigh_base_and_accelerator,
                R.drawable.sealant_mixing,
                R.drawable.mixed_sealant,
        };
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Context context = Sealant1_2_3_5thPage.this;
