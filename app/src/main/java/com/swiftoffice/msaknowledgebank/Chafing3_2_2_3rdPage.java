...
public class Chafing3_2_2_3rdPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chafing_3_2_2_3rd_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 1) {
                    Intent previousIntent = new Intent(Chafing3_2_2_3rdPage.this, Chafing3_2_2_1stPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 2) {
                    Intent previousIntent = new Intent(Chafing3_2_2_3rdPage.this, Chafing3_2_2_2ndPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 4) {
                    Intent nextIntent = new Intent(Chafing3_2_2_3rdPage.this, Chafing3_2_2_4thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 5) {
                    Intent nextIntent = new Intent(Chafing3_2_2_3rdPage.this, Chafing3_2_2_5thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 6) {
                    Intent nextIntent = new Intent(Chafing3_2_2_3rdPage.this, Chafing3_2_2_6thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
            }
        });
        txtHeading.setText(Html.fromHtml("<p><u>Wrap-Around Protection</u></p>"));
        SpannableString ss1 = new SpannableString("Wrap-Around Protection Examples");
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(Chafing3_2_2_3rdPage.this, MainPage.class);
    ...
    public void displayClampingImagePopup() {
        ...
        txtTitle.setText("Example of a Wrap-Around sleeving installation");
        txtImageIndex.setText("Current Image: 1/3");
        Chafing3_2_2_3rdPage.ImagePagerAdapter adapter = new Chafing3_2_2_3rdPage.ImagePagerAdapter();
        viewPager.setAdapter(adapter);
        imageDialog.setTitle("Wrap-Around Protection Examples");
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position == 0) {
                    ...
                    txtTitle.setText("Example of Wrap-Around sleeving application");
                }
                else if (position == 2) {
                    txtTitle.setText("Different sizes of Wrap-Around sleeving");
                }
            }
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(Chafing3_2_2_3rdPage.this, ContentsPage.class);
    ...
    private class ImagePagerAdapter extends PagerAdapter { //swipe image
        private int[] mImages = new int[]{
                R.drawable.wrap_around_sleeving_installation,
                R.drawable.wraparound_sleeve_example,
                R.drawable.wraparound_sleeving_sizes,
        };
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Context context = Chafing3_2_2_3rdPage.this;
