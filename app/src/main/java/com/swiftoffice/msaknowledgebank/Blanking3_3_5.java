...
public class Blanking3_3_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.blanking_3_3_5);
        ...
        SpannableString ss1 = new SpannableString("Blanking of Connectors Examples");
        ss1.setSpan(new UnderlineSpan(), 0, ss1.length(), 0);
        SpannableString ss2 = new SpannableString("Blanking of Connectors T.O. 1-1A-14 WP 007 00");
        ...
        txtHeading.setText(Html.fromHtml("<p><u>Blanking of Connectors</u></p>"));
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(Blanking3_3_5.this, MainPage.class);
        startActivity(MainIntent);
        finish();
    }


    public void displayBlankingImagePopup() {
        ...
        txtTitle.setText("Blanking Caution");
        ImagePagerAdapter adapter = new ImagePagerAdapter();
        viewPager.setAdapter(adapter);
        imageDialog.setTitle("Blanking of Connectors Examples");
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position == 0) {
                    ...
                    txtTitle.setText("Blanking Note");
                }
                else if (position == 2) {
                    txtTitle.setText("Example of pressure sensitive tape application on aircraft");
                }
                else if (position == 3) {
                    txtTitle.setText("Tape and Heat Shrinkable Caps Before & After");
                }
            }
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(Blanking3_3_5.this, ContentsPage.class);
    ...
    private class ImagePagerAdapter extends PagerAdapter { //swipe image
        private int[] mImages = new int[] {
                R.drawable.blanking_caution,
                R.drawable.blanking_note,
                R.drawable.pressure_tape_aircraft,
                R.drawable.tape_cap_before_after,
        };
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Context context = Blanking3_3_5.this;
            imgBlank = new ImageView(context);
            imgBlank.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
            imgBlank.setImageResource(mImages[position]);
            PhotoViewAttacher zoomImage = new PhotoViewAttacher(imgBlank);
            zoomImage.update();
            ((ViewPager) container).addView(imgBlank, 0);
            return imgBlank;
        }
