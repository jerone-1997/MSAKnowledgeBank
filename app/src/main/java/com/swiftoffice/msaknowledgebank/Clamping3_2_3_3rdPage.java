...
public class Clamping3_2_3_3rdPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.clamping_3_2_3_3rd_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 1) {
                    Intent previousIntent = new Intent(Clamping3_2_3_3rdPage.this, Clamping3_2_3_1stPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                if (page == 2) {
                    Intent previousIntent = new Intent(Clamping3_2_3_3rdPage.this, Clamping3_2_3_2ndPage.class);
                    startActivity(previousIntent);
                    finish();
                }
            }
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(Clamping3_2_3_3rdPage.this, MainPage.class);
    ...
    public void displayClampingImagePopup() {
        ...
        Clamping3_2_3_3rdPage.ImagePagerAdapter adapter = new Clamping3_2_3_3rdPage.ImagePagerAdapter();
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(Clamping3_2_3_3rdPage.this, ContentsPage.class);
    ...
    private class ImagePagerAdapter extends PagerAdapter { //swipe image
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Context context = Clamping3_2_3_3rdPage.this;
