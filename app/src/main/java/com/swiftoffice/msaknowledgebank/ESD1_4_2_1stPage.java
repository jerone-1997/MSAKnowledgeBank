...
public class ESD1_4_2_1stPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 2) {
                    Intent nextIntent = new Intent(ESD1_4_2_1stPage.this, ESD1_4_2_2ndPage.class);
                    startActivity(nextIntent);
                    finish();
                }
            }
        });
        txtHeading.setText(Html.fromHtml("<p><u></u></p>"));
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(ESD1_4_2_1stPage.this, MainPage.class);
    ...
    public void displayBondingImagePopup() {
        ...
        txtTitle.setText("");
        txtImageIndex.setText("Current Image: 1/");
        ESD1_4_2_1stPage.ImagePagerAdapter adapter = new ESD1_4_2_1stPage.ImagePagerAdapter();
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(ESD1_4_2_1stPage.this, ContentsPage.class);
    ...
    private class ImagePagerAdapter extends PagerAdapter { //swipe image
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Context context = ESD1_4_2_1stPage.this;
