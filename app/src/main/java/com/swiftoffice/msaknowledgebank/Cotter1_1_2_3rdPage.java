...
public class Cotter1_1_2_3rdPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cotter_pins_1_1_2_3rd_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 2) {
                    Intent previousIntent = new Intent(Cotter1_1_2_3rdPage.this, Cotter1_1_2_2ndPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 1) {
                    Intent previousIntent = new Intent(Cotter1_1_2_3rdPage.this, Cotter1_1_2_1stPage.class);
                    startActivity(previousIntent);
                    finish();
                }
            }
        });
        txtHeading.setText(Html.fromHtml("<p><u>Cotter Pin Hole Line Up</u></p>"));
        SpannableString ss1 = new SpannableString("Perfect examples of securing hardware with Cotter Pin");
        ss1.setSpan(new UnderlineSpan(), 0, ss1.length(), 0);
        SpannableString ss2 = new SpannableString("Website on securing hardware with Cotter Pin");
        ...
        txtHyperLink2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.setData(Uri.parse("http://www.flight-mechanic.com/rigging-checks-pt3/"));
                startActivity(i);
            }
        });
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(Cotter1_1_2_3rdPage.this, MainPage.class);
    ...
    public void displayWasherImagePopup() {
        ...
        imageDialog.setTitle("Perfect examples of securing hardware with Cotter Pin");
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(Cotter1_1_2_3rdPage.this, ContentsPage.class);
    ...
    private class ImagePagerAdapter extends PagerAdapter { //swipe image
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Context context = Cotter1_1_2_3rdPage.this;
