...
public class GeneralSoldering3_1_5_7thPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.general_soldering_3_1_5_7th_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 1) {
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_7thPage.this, GeneralSoldering3_1_5_1stPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 2) {
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_7thPage.this, GeneralSoldering3_1_5_2ndPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 3) {
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_7thPage.this, GeneralSoldering3_1_5_3rdPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 4) {
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_7thPage.this, GeneralSoldering3_1_5_4thPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 5) {
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_7thPage.this, GeneralSoldering3_1_5_6thPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 6) {
                    ...
                    Intent nextIntent = new Intent(GeneralSoldering3_1_5_7thPage.this, GeneralSoldering3_1_5_8thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 9) {
                    Intent nextIntent = new Intent(GeneralSoldering3_1_5_7thPage.this, GeneralSoldering3_1_5_9thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 10) {
                    Intent nextIntent = new Intent(GeneralSoldering3_1_5_7thPage.this, GeneralSoldering3_1_5_10thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 11) {
                    Intent nextIntent = new Intent(GeneralSoldering3_1_5_7thPage.this, GeneralSoldering3_1_5_11thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
            }
        });
        txtHeading.setText(Html.fromHtml("<p><u>General Soldering Procedures (Part 3)</u></p>"));
        txtPrevious.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent nextIntent = new Intent(GeneralSoldering3_1_5_7thPage.this, GeneralSoldering3_1_5_6thPage.class);
                startActivity(nextIntent);
                finish();
            }
        });
        txtNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent previousIntent = new Intent(GeneralSoldering3_1_5_7thPage.this, GeneralSoldering3_1_5_8thPage.class);
                startActivity(previousIntent);
                finish();
            }
        });
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(GeneralSoldering3_1_5_7thPage.this, MainPage.class);
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(GeneralSoldering3_1_5_7thPage.this, ContentsPage.class);
