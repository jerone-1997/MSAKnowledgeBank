...
public class Sealant1_2_3_4thPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sealant_1_2_3_4th_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 1) {
                    Intent previousIntent = new Intent(Sealant1_2_3_4thPage.this, Sealant1_2_3_1stPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 2) {
                    Intent previousIntent = new Intent(Sealant1_2_3_4thPage.this, Sealant1_2_3_2ndPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 3) {
                    Intent previousIntent = new Intent(Sealant1_2_3_4thPage.this, Sealant1_2_3_3rdPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 5) {
                    Intent nextIntent = new Intent(Sealant1_2_3_4thPage.this, Sealant1_2_3_5thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
            }
        });
        txtHeading.setText(Html.fromHtml("<p><u>(3) Sealant Compounds (Part 2)</u></p>"));
        ...
        txtNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent nextIntent = new Intent(
                        Sealant1_2_3_4thPage.this, Sealant1_2_3_5thPage.class);
                startActivity(nextIntent);
                finish();
            }
        });
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(Sealant1_2_3_4thPage.this, MainPage.class);
    ...
    public void displaySealantImagePopup() {
        ...
        Sealant1_2_3_4thPage.ImagePagerAdapter adapter = new Sealant1_2_3_4thPage.ImagePagerAdapter();
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(Sealant1_2_3_4thPage.this, ContentsPage.class);
    ...
    private class ImagePagerAdapter extends PagerAdapter { //swipe image
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Context context = Sealant1_2_3_4thPage.this;
