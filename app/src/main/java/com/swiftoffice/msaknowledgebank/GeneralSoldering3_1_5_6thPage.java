...
public class GeneralSoldering3_1_5_6thPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.general_soldering_3_1_5_6th_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 1) {
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_6thPage.this, GeneralSoldering3_1_5_1stPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 2) {
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_6thPage.this, GeneralSoldering3_1_5_2ndPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 3) {
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_6thPage.this, GeneralSoldering3_1_5_3rdPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 4) {
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_6thPage.this, GeneralSoldering3_1_5_4thPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 5) {
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_6thPage.this, GeneralSoldering3_1_5_5thPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 7) {
                    Intent nextIntent = new Intent(GeneralSoldering3_1_5_6thPage.this, GeneralSoldering3_1_5_7thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 8) {
                    Intent nextIntent = new Intent(GeneralSoldering3_1_5_6thPage.this, GeneralSoldering3_1_5_8thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 9) {
                    Intent nextIntent = new Intent(GeneralSoldering3_1_5_6thPage.this, GeneralSoldering3_1_5_9thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 10) {
                    Intent nextIntent = new Intent(GeneralSoldering3_1_5_6thPage.this, GeneralSoldering3_1_5_10thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 11) {
                    Intent nextIntent = new Intent(GeneralSoldering3_1_5_6thPage.this, GeneralSoldering3_1_5_11thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
            }
        });
        txtHeading.setText(Html.fromHtml("<p><u>General Soldering Procedures (Part 2)</u></p>"));
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(GeneralSoldering3_1_5_6thPage.this, MainPage.class);
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(GeneralSoldering3_1_5_6thPage.this, ContentsPage.class);
