...
public class GeneralSoldering3_1_5_10thPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.general_soldering_3_1_5_10th_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 1) {
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_10thPage.this, GeneralSoldering3_1_5_1stPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 2) {
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_10thPage.this, GeneralSoldering3_1_5_2ndPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 3) {
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_10thPage.this, GeneralSoldering3_1_5_3rdPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 4) {
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_10thPage.this, GeneralSoldering3_1_5_4thPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 5) {
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_10thPage.this, GeneralSoldering3_1_5_6thPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 6) {
                    ...
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_10thPage.this, GeneralSoldering3_1_5_7thPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 8) {
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_10thPage.this, GeneralSoldering3_1_5_8thPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 9) {
                    Intent previousIntent = new Intent(GeneralSoldering3_1_5_10thPage.this, GeneralSoldering3_1_5_9thPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 11) {
                    Intent nextIntent = new Intent(GeneralSoldering3_1_5_10thPage.this, GeneralSoldering3_1_5_11thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
            }
        });
        txtHeading.setText(Html.fromHtml("<p><u>General Soldering Procedures (Part 6)</u></p>"));
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(GeneralSoldering3_1_5_10thPage.this, MainPage.class);
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(GeneralSoldering3_1_5_10thPage.this, ContentsPage.class);
