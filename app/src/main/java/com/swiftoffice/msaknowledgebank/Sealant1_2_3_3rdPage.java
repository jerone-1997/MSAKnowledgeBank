...
public class Sealant1_2_3_3rdPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sealant_1_2_3_3rd_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 1) {
                    Intent previousIntent = new Intent(Sealant1_2_3_3rdPage.this, Sealant1_2_3_1stPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 2) {
                    Intent previousIntent = new Intent(Sealant1_2_3_3rdPage.this, Sealant1_2_3_2ndPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 4) {
                    Intent nextIntent = new Intent(Sealant1_2_3_3rdPage.this, Sealant1_2_3_4thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 5) {
                    Intent nextIntent = new Intent(Sealant1_2_3_3rdPage.this, Sealant1_2_3_5thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
            }
        });
        txtHeading.setText(Html.fromHtml("<p><u>(3) Sealant Compounds (Part 1)</u></p>"));
        SpannableString ss1 = new SpannableString("One Part & Two Part Sealant Examples");
        ss1.setSpan(new UnderlineSpan(), 0, ss1.length(), 0);
        SpannableString ss2 = new SpannableString("Sealant Compounds T.O.");
        ...
        txtNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent nextIntent = new Intent(
                        Sealant1_2_3_3rdPage.this, Sealant1_2_3_4thPage.class);
                startActivity(nextIntent);
                finish();
            }
        });
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(Sealant1_2_3_3rdPage.this, MainPage.class);
    ...
    public void displaySealantImagePopup() {
        ...
        txtTitle.setText("Example of One Part Sealant");
        txtImageIndex.setText("Current Image: 1/3");
        Sealant1_2_3_3rdPage.ImagePagerAdapter adapter = new Sealant1_2_3_3rdPage.ImagePagerAdapter();
        viewPager.setAdapter(adapter);
        imageDialog.setTitle("One Part & Two Part Sealant Examples");
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position == 0) {
                    ...
                    txtTitle.setText("Example of Two Part Sealant");
                }
                else if (position == 2) {
                    txtTitle.setText("Differences between One & Two Part Sealant");
                }
            }
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(Sealant1_2_3_3rdPage.this, ContentsPage.class);
    ...
    private class ImagePagerAdapter extends PagerAdapter { //swipe image
        private int[] mImages = new int[]{
                R.drawable.sealant_one_part,
                R.drawable.sealant_two_part,
                R.drawable.one_two_part_sealant,
        };
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Context context = Sealant1_2_3_3rdPage.this;
