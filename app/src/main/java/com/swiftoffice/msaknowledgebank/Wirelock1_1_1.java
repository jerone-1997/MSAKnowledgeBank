...
public class Wirelock1_1_1 extends AppCompatActivity {
    private FloatingActionButton btnBack;
    private ImageView imgWireLock;
    private TextView txtTitle, txtHeading, txtImageIndex, txtHyperLink1, txtHyperLink2;
    private ViewPager viewPager;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.wire_lock_1_1_1);
        ...
        txtHeading.setText(Html.fromHtml("<p><u>Wire-Locks</u></p>"));
        SpannableString ss1 = new SpannableString("Perfect Examples of Wire-Locking");
        ss1.setSpan(new UnderlineSpan(), 0, ss1.length(), 0);
        SpannableString ss2 = new SpannableString("Wire-Locking T.O. 01-1A-14 WP 018 00");
        ...
        txtHyperLink2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.setData(Uri.parse("https://drive.google.com/file/d/1EVrElZJO648yjqfT86fqkGRmhAOKvrdx/view?usp=sharing"));
                startActivity(i);
            }
        });
    }
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(Wirelock1_1_1.this, MainPage.class);
        startActivity(MainIntent);
        finish();
    }

    public void displayWireLockImagePopup() {
        ...
        txtTitle.setText("Some examples of a Perfect Wire-Locking");
        txtImageIndex.setText("Current Image: 1/3");
        ImagePagerAdapter adapter = new ImagePagerAdapter();
        viewPager.setAdapter(adapter);
        imageDialog.setTitle("Perfect Examples of Wire-Locking");
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position == 0) {
                    ...
                    txtTitle.setText("Perfect example of a wire lock with proper pigtail");
                }
                else if (position == 2) {
                    txtTitle.setText("Example on how to use Locking Pliers");
                }
            }
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(Wirelock1_1_1.this, ContentsPage.class);
    ...
    private class ImagePagerAdapter extends PagerAdapter { //swipe image
        private int[] mImages = new int[] {
                R.drawable.wire_locking_examples_1,
                R.drawable.wire_locking_examples_2,
                R.drawable.locking_pliers,
        };
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Context context = Wirelock1_1_1.this;
            imgWireLock = new ImageView(context);
            imgWireLock.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
            imgWireLock.setImageResource(mImages[position]);
            PhotoViewAttacher zoomImage = new PhotoViewAttacher(imgWireLock);
            zoomImage.update();
            ((ViewPager) container).addView(imgWireLock, 0);
            return imgWireLock;
        }
