...
public class Torque1_1_7_1stPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.torque_loading_1_1_7_1st_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 2) {
                    Intent nextIntent = new Intent(Torque1_1_7_1stPage.this, Torque1_1_7_2ndPage.class);
                    startActivity(nextIntent);
                    finish();
                }
            }
        });
        txtHeading.setText(Html.fromHtml("<p><u>Procedures to ensure proper torque (Part 1)</u></p>"));
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(Torque1_1_7_1stPage.this, MainPage.class);
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(Torque1_1_7_1stPage.this, ContentsPage.class);
