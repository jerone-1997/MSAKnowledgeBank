...
public class WireInsulationRepair3_1_4_1stPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wire_insulation_repair_3_1_4_1st_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 2) {
                    Intent nextIntent = new Intent(WireInsulationRepair3_1_4_1stPage.this, WireInsulationRepair3_1_4_2ndPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 3) {
                    Intent nextIntent = new Intent(WireInsulationRepair3_1_4_1stPage.this, WireInsulationRepair3_1_4_3rdPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 4) {
                    Intent nextIntent = new Intent(WireInsulationRepair3_1_4_1stPage.this, WireInsulationRepair3_1_4_4thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 5) {
                    Intent nextIntent = new Intent(WireInsulationRepair3_1_4_1stPage.this, WireInsulationRepair3_1_4_5thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
            }
        });
        txtHeading.setText(Html.fromHtml("<p><u>Wire Insulation Repair (Part 1)</u></p>"));
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(WireInsulationRepair3_1_4_1stPage.this, MainPage.class);
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(WireInsulationRepair3_1_4_1stPage.this, ContentsPage.class);
