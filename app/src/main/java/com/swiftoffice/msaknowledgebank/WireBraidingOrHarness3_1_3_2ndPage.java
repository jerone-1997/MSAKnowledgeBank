...
public class WireBraidingOrHarness3_1_3_2ndPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wire_braiding_harness_3_1_3_2nd_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 1) {
                    Intent previousIntent = new Intent(WireBraidingOrHarness3_1_3_2ndPage.this, WireBraidingOrHarness3_1_3_1stPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 3) {
                    Intent nextIntent = new Intent(WireBraidingOrHarness3_1_3_2ndPage.this, WireBraidingOrHarness3_1_3_3rdPage.class);
                    startActivity(nextIntent);
                    finish();
                }
            }
        });
        txtHeading.setText(Html.fromHtml("<p><u>Wire Braiding/Harness Repair (Part 2)</u></p>"));
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(WireBraidingOrHarness3_1_3_2ndPage.this, MainPage.class);
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(WireBraidingOrHarness3_1_3_2ndPage.this, ContentsPage.class);
