...
public class Nuts1_1_3_2ndPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nuts_1_1_3_2nd_page);
        ...
        SpannableString ss1 = new SpannableString("Perfect Examples of Self Locking Nuts & Features");
        ss1.setSpan(new UnderlineSpan(), 0, ss1.length(), 0);
        SpannableString ss2 = new SpannableString("Self Locking Nuts T.O.");
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 1) {
                    Intent previousIntent = new Intent(Nuts1_1_3_2ndPage.this, Nuts1_1_3_1stPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 3) {
                    Intent nextIntent = new Intent(Nuts1_1_3_2ndPage.this, Nuts1_1_3_3rdPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 4) {
                    Intent nextIntent = new Intent(Nuts1_1_3_2ndPage.this, Nuts1_1_3_4thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 5) {
                    Intent nextIntent = new Intent(Nuts1_1_3_2ndPage.this,Nuts1_1_3_5thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
            }
        });
        txtHeading.setText(Html.fromHtml("<p><u>1. Self Locking Nuts (Part 2)</u></p>"));
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(Nuts1_1_3_2ndPage.this, MainPage.class);
    ...
    public void displayNutsImagePopup() {
        ...
        txtTitle.setText("Minimum prevailing torque values");
        ImagePagerAdapter adapter = new ImagePagerAdapter();
        viewPager.setAdapter(adapter);
        imageDialog.setTitle("Perfect Examples of Self Locking Nuts & Features");
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position == 0) {
                    ...
                    txtTitle.setText("Self-Locking Nuts features");
                }
                else if (position == 2) {
                    txtTitle.setText("Types of Self-Locking Nuts");
                }
            }
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(Nuts1_1_3_2ndPage.this, ContentsPage.class);
    ...
    private class ImagePagerAdapter extends PagerAdapter { //swipe image
        private int[] mImages = new int[] {
                R.drawable.prevailing_torque_values,
                R.drawable.self_locking_nuts_features,
                R.drawable.self_locking_nuts_types,
        };
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Context context = Nuts1_1_3_2ndPage.this;
