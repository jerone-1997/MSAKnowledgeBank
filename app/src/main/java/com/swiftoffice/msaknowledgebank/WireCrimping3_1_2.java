...
public class WireCrimping3_1_2 extends AppCompatActivity {
    private FloatingActionButton btnBack;
    private ImageView imgWireCrimping;
    private TextView txtTitle, txtHeading, txtImageIndex, txtHyperLink1, txtHyperLink2;
    private ViewPager viewPager;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.wire_crimping_3_1_2);
        ...
        txtHeading.setText(Html.fromHtml("<p><u>Wire Crimping</u></p>"));
        SpannableString ss1 = new SpannableString("Perfect Examples of Wire Crimping");
        ss1.setSpan(new UnderlineSpan(), 0, ss1.length(), 0);
        SpannableString ss2 = new SpannableString("Wire Crimping T.O.1-1A-14 WP 013 00 to 014 00");
        ...
        txtHyperLink2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.setData(Uri.parse("https://drive.google.com/file/d/1qKMJvpTF3HAlQsYg62vquaY0w1aM__Bh/view?usp=sharing"));
                startActivity(i);
            }
        });
    }
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(WireCrimping3_1_2.this, MainPage.class);
    ...
    public void displayWireStrippingImagePopup() {
        ...
        txtTitle.setText("Using crimping tool");
        txtImageIndex.setText("Current Image: 1/4");
        ImagePagerAdapter adapter = new ImagePagerAdapter();
        viewPager.setAdapter(adapter);
        imageDialog.setTitle("Perfect Examples of Wire Crimping");
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position == 0) {
                    ...
                    txtTitle.setText("Example of a typical cross sectional crimp contact");
                }
                else if (position == 2) {
                    txtTitle.setText("Cross sections of crimped contact");
                }
                else if (position == 3) {
                    txtTitle.setText("Acceptable and Unacceptable crimping shapes");
                }
                else if (position == 4) {
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(WireCrimping3_1_2.this, ContentsPage.class);
    ...
    private class ImagePagerAdapter extends PagerAdapter { //swipe image
        private int[] mImages = new int[] {
                R.drawable.crimping_tool,
                R.drawable.cross_sectional_crimp,
                R.drawable.cross_sectional_shapes,
                R.drawable.acceptable_unacceptable_crimp,
        };
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Context context = WireCrimping3_1_2.this;
            imgWireCrimping = new ImageView(context);
            imgWireCrimping.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
            imgWireCrimping.setImageResource(mImages[position]);
            PhotoViewAttacher zoomImage = new PhotoViewAttacher(imgWireCrimping);
            zoomImage.update();
            ((ViewPager) container).addView(imgWireCrimping, 0);
            return imgWireCrimping;
        }
