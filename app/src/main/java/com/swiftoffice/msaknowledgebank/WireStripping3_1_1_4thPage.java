...
public class WireStripping3_1_1_4thPage extends AppCompatActivity {
    ...
    private TextView txtPrevious, txtTitle, txtHeading, txtImageIndex, txtHyperLink1, txtHyperLink2;
    private ViewPager viewPager;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.wire_stripping_3_1_1_4th_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 1) {
                    Intent previousIntent = new Intent(WireStripping3_1_1_4thPage.this, WireStripping3_1_1_1stPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 2) {
                    Intent previousIntent = new Intent(WireStripping3_1_1_4thPage.this, WireStripping3_1_1_2ndPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 3) {
                    Intent previousIntent = new Intent(WireStripping3_1_1_4thPage.this, WireStripping3_1_1_3rdPage.class);
                    startActivity(previousIntent);
                    finish();
                }
            }
        });
        txtHeading.setText(Html.fromHtml("<p><u>Stripping Coaxial Cable</u></p>"));
        SpannableString ss1 = new SpannableString("Examples of a Perfect Stripped Copper Wire and Tools Used");
        ...
        txtHyperLink2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.setData(Uri.parse("https://drive.google.com/file/d/13wK5IorUhyIPYJO7Cl6jUAOLAjEGdOTD/view?usp=sharing"));
                startActivity(i);
            }
        });
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(WireStripping3_1_1_4thPage.this, MainPage.class);
    ...
    public void displayWireStrippingImagePopup() {
        ...
        txtTitle.setText("Warning when wire stripping");
        txtImageIndex.setText("Current Image: 1/3");
        ImagePagerAdapter adapter = new ImagePagerAdapter();
        viewPager.setAdapter(adapter);
        imageDialog.setTitle("Examples of a Perfect Stripped Copper Wire and Tools Used");
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position == 0) {
                    ...
                    txtTitle.setText("Examples of a perfect stripped copper wire");
                }
                else if (position == 2) {
                    txtTitle.setText("Examples of tools used to cut copper wire and coaxial cable");
                }
            }
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(WireStripping3_1_1_4thPage.this, ContentsPage.class);
    ...
    private class ImagePagerAdapter extends PagerAdapter { //swipe image
        private int[] mImages = new int[] {
                R.drawable.wire_stripping_warning,
                R.drawable.copper_wire_example_1,
                R.drawable.copper_wire_tools
        };
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Context context = WireStripping3_1_1_4thPage.this;
