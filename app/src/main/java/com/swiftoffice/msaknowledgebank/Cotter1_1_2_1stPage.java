...
public class Cotter1_1_2_1stPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cotter_pins_1_1_2_1st_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 2) {
                    Intent nextIntent = new Intent(Cotter1_1_2_1stPage.this, Cotter1_1_2_2ndPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 3) {
                    Intent nextIntent = new Intent(Cotter1_1_2_1stPage.this, Cotter1_1_2_3rdPage.class);
                    startActivity(nextIntent);
                    finish();
                }
            }
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(Cotter1_1_2_1stPage.this, MainPage.class);
    ...
    public void displayCotterPinImagePopup() {
        ...
        Cotter1_1_2_1stPage.ImagePagerAdapter adapter = new Cotter1_1_2_1stPage.ImagePagerAdapter();
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(Cotter1_1_2_1stPage.this, ContentsPage.class);
    ...
    private class ImagePagerAdapter extends PagerAdapter { //swipe image
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Context context = Cotter1_1_2_1stPage.this;
