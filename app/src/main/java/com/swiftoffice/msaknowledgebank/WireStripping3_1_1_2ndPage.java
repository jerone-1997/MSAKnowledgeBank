...
public class WireStripping3_1_1_2ndPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wire_stripping_3_1_1_2nd_page);
        ...
        seekMovePages.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (page == 1) {
                    Intent previousIntent = new Intent(WireStripping3_1_1_2ndPage.this, WireStripping3_1_1_1stPage.class);
                    startActivity(previousIntent);
                    finish();
                }
                else if (page == 3) {
                    Intent nextIntent = new Intent(WireStripping3_1_1_2ndPage.this, WireStripping3_1_1_3rdPage.class);
                    startActivity(nextIntent);
                    finish();
                }
                else if (page == 4) {
                    Intent nextIntent = new Intent(WireStripping3_1_1_2ndPage.this, WireStripping3_1_1_4thPage.class);
                    startActivity(nextIntent);
                    finish();
                }
            }
        });
        txtHeading.setText(Html.fromHtml("<p><u>Inspection of stripped wire (Part 1)</u></p>"));
    ...
    public void goToMainPage() {
        Intent MainIntent = new Intent(WireStripping3_1_1_2ndPage.this, MainPage.class);
    ...
    public void goToMSAContents() {
        Intent MSAIntent = new Intent(WireStripping3_1_1_2ndPage.this, ContentsPage.class);
